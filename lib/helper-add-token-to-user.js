(function() {
  ...
  module.exports = function(oauthAuth, baseUrl, accountId, userId, clientId, realm, scope, user, cb) {
    if (clientId) {
      return oauthAuth.createOrReuseTokenForUserId(accountId, userId, clientId, realm, scope, null, (function(_this) {
