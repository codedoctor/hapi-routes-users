(function() {
  var Boom, Hoek, Joi, helperAddTokenToUser, i18n, protoGetAll, url, validationSchemas, _;
  ...
  module.exports = function(plugin, options) {
    ...
    plugin.route({
      ...
      handler: function(request, reply) {
        ...
        return methodsUsers()["delete"](options.accountId, usernameOrIdOrMe, null, function(err, user) {
    ...
    plugin.route({
      ...
      handler: function(request, reply) {
        ...
        return methodsUsers().patch(options.accountId, usernameOrIdOrMe, request.payload, null, function(err, user) {
          var payload, primaryEmail, sendAttempt;
          if (err) {
            return reply(err);
          }
